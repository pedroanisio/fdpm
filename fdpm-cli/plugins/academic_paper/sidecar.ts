...
export const PROFILE_ID = "profile:academic-paper:0.3" as const;
export const PLUGIN_ID = "fdpm.academic-paper" as const;
...
// expr-helper function namespace. We use "acad" rather than "fdpm" so
// our primitives appear as `acad:Paper`, `acad:Author`, etc. — matching
// the per-plugin-prefix convention already in use by the other
// fdpm-vendor plugins (fs:, dnis:, plan:, sw:, spec:, recipe:). This
// also keeps us collision-free if future bridge-generated plugins
// reuse vendor="fdpm".
