...
const documentSpec: PrimitiveSpec = {
  ...
  fields: {
    ...
    peer_spec: "fdpm-cli/packages/zod-bridge/README.md",
...
const references: PrimitiveSpec[] = [
  ...
  { id: "spec:ref:zod-bridge-readme", type: "spec:Reference", fields: { kind: "repo_file", citation: "@fdpm/zod-bridge README — the Zod v4 bridge contract as actually implemented: emitted artefacts, the 23 CEL translation rules, feature flags and declared losses.", locator: "fdpm-cli/packages/zod-bridge/README.md", verification: "verified", verification_note: "The document_plan plugin is generated by this bridge. Supersedes a prior citation to a bridge SPEC under docs/specs/ that was marked verified but has never existed in this repository — corrected 2026-08-29 by the doc-hygiene audit." } },
