...
export const SERVER_INSTRUCTIONS: string = [
  ...
  `   - fdpm://audit/report/{window} — tool-call outcomes and error classes from the audit log (1h|24h|7d|all)`,
