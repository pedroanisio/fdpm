    ...
    primitive_types: [
      {
        id: "t:a",
        fields: [],
        id_format: { pattern: "^a-[a-z0-9]+$", uniqueness: "project" },
        inline_structs: [],
      ...
      },
      {
        id: "t:b",
        fields: [],
        id_format: { pattern: "^b-[a-z0-9]+$", uniqueness: "project" },
        inline_structs: [],
        is_partition_unit: false,
      },
      {
        id: "t:c",
        fields: [],
        id_format: { pattern: "^c-[a-z0-9]+$", uniqueness: "project" },
        inline_structs: [],
        is_partition_unit: false,
      },
      {
        id: "t:z",
        fields: [],
        id_format: { pattern: "^z-[a-z0-9]+$", uniqueness: "project" },
        inline_structs: [],
        is_partition_unit: false,
      },
    ],
      ...
      primitive_types: [
        {
          id: "t:a",
          fields: [],
          id_format: { pattern: "^a-[a-z]+$", uniqueness: "project" },
          inline_structs: [],
          is_partition_unit: false,
        },
        {
          id: "t:b",
          fields: [],
          id_format: { pattern: "^b-[a-z]+$", uniqueness: "project" },
          inline_structs: [],
          is_partition_unit: false,
        },
        {
          id: "t:z",
          fields: [],
          id_format: { pattern: "^z-[a-z]+$", uniqueness: "project" },
          inline_structs: [],
          is_partition_unit: false,
        },
      ],
    ...
    await host.registerProfile({
      ...
      primitive_types: [
        ...
        },
        {
          id: "t:bad",
          fields: [],
          id_format: { pattern: "^bad-[a-z]+$", uniqueness: "project" },
          inline_structs: [],
          is_partition_unit: false,
        },
        {
