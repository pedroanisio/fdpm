...
disclaimer:
  ...
  generated_by: "Claude Opus 4.7 (1M context) via Claude Code; moved from README.md and revised by Claude Fable 5.1 via Claude Code"
  date: "2026-09-04"
---
...
([docs/specs/SPEC-CORE.md](../specs/SPEC-CORE.md)) **and** the
companion Pluggable Architecture SPEC v1.1
([docs/specs/SPEC-PLUGGABLE-ARCHITECTURE.md](../specs/SPEC-PLUGGABLE-ARCHITECTURE.md))
...
([docs/specs/SPEC-DNIS.md](../specs/SPEC-DNIS.md)) as a normative
...
[docs/architecture/PROFILES.md](../architecture/PROFILES.md), generated from
...
The recorded ADRs live at [docs/adrs/decisions.md](../adrs/decisions.md) and
...
- `core-versioning-001` — `spec_core` is `"1.3"`; revision is
  `"1.3.0"` (`SPEC_CORE_REVISION` and `HOST_VERSION` in
  `src/core/version/spec.ts`); both reported by `fdpm version`.
...
- [docs/specs/SPEC-CORE.md](../specs/SPEC-CORE.md) — the SPEC this implements.
- [docs/specs/SPEC-DNIS.md](../specs/SPEC-DNIS.md) — Document Node Identity Specification; adopted by SPEC-CORE 1.2 §5.6.
- [docs/specs/SPEC-SECTIONS-TREE.md](../specs/SPEC-SECTIONS-TREE.md) — sections-as-DNIS-Nodes proposal; SPEC-CORE / SPEC-DNIS migrated to the DNIS-backed section path.
- [docs/specs/SPEC-RENDER-DSL.md](../specs/SPEC-RENDER-DSL.md) — render-time DSL; helper-set v1.2.0 ships `fn.section_of`.
- [docs/specs/SPEC-EXPRESSION-RUNTIME.md](../specs/SPEC-EXPRESSION-RUNTIME.md) — host CEL runtime + helper-set + Tier-A/B activation.
- [docs/specs/SPEC-PLUGGABLE-ARCHITECTURE.md](../specs/SPEC-PLUGGABLE-ARCHITECTURE.md) — companion SPEC; server-side capabilities implemented (see "Plugin runtime" above).
- [docs/adrs/decisions.md](../adrs/decisions.md) — architectural decision records, generated from `sw:Decision` primitives by [fdpm-cli/scripts/build-adrs.ts](../../fdpm-cli/scripts/build-adrs.ts).
