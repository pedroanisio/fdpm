...
- **`cap:shared-constants` for cross-runtime constants** — Would address systematically the constants mirrored by hand across the Python and TypeScript runtimes (operation kinds, id rules, version pins), which today drift silently.
